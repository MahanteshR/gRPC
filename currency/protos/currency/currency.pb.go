...
type RateRequest struct {
	...
	Base        string `protobuf:"bytes,1,opt,name=Base,proto3,json=base,proto3" json:"Base,omitempty"`
	Destination string `protobuf:"bytes,2,opt,name=Destination,proto3,json=destination,proto3" json:"Destination,omitempty"`
}
